            ...
            dataPointSelection: function(event, chartContext, opt) {
                ...
                switch(opt.w.globals.labels[opt.dataPointIndex]) {
					...
					var labelGOR = opt.w.globals.series[0][0];						
						if(labelGOR<=6){
							window.open("/limesurvey/GoalsNResources-adhoc.html",'_blank','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0,location=no');
						}else if(labelGOR>6 && labelGOR <=12){
								window.open("/limesurvey/GoalsNResources-aware.html",'_blank','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0,location=no');
						}else if(labelGOR>12 && labelGOR <=18){
								window.open("/limesurvey/GoalsNResources-managed.html",'_blank','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0,location=no');
						}else if(labelGOR>18 && labelGOR <=24){
								window.open("/limesurvey/GoalsNResources-engaged.html",'_blank','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0,location=no');
						}else if(labelGOR>24 && labelGOR <=30){
								window.open("/limesurvey/GoalsNResources-leading.html",'_blank','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0,location=no');
						};
					break;
					case 'Corporate Alignment':
					var labelCorp = opt.w.globals.series[0][1];						
						if(labelCorp<=6){
							window.open("/limesurvey/CorporateAlignment-adhoc.html",'Corporate','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
					...
					var labelComm = opt.w.globals.series[0][2];						
						if(labelComm<=6){
							window.open("/limesurvey/CommunityEcosystem-adhoc.html",'Community','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
					...
					var labelOpr = opt.w.globals.series[0][3];						
						if(labelOpr<=6){
							window.open("/limesurvey/Operations-adhoc.html",'Operations','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
					...
					var labelCulture = opt.w.globals.series[0][4];						
						if(labelCulture<=6){
							window.open("/limesurvey/Culture-adhoc.html",'Culture','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelCulture >6 && labelCulture <=12){
								window.open("/limesurvey/Culture-aware.html",'Culture','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelCulture >12 && labelCulture <=18){
								window.open("/limesurvey/Culture-managed.html",'Culture','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelCulture >18 && labelCulture <=24){
								window.open("/limesurvey/Culture-engaged.html",'Culture','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelCulture >24 && labelCulture <=30){
								window.open("/limesurvey/Culture-leading.html",'Culture','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						};
					break;	
                    case 'Lifecycle Management':
					var labelcons = opt.w.globals.series[0][0];						
						if(labelcons<=6){
							window.open("/limesurvey/lifecyclemgt-adhoc.html",'Lifecycle','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
					...
					var labelcons = opt.w.globals.series[0][1];						
						if(labelcons<=6){
							window.open("/limesurvey/riskmgt-adhoc.html",'Risk','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelcons>6 && labelcons <=12){
					...
					var labelcons = opt.w.globals.series[0][2];						
						if(labelcons<=6){
							window.open("/limesurvey/compliancemgt-adhoc.html",'Compliance','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelcons>6 && labelcons <=12){
					...
					var labelcons = opt.w.globals.series[0][3];						
						if(labelcons<=6){
							window.open("/limesurvey/securitymgt-adhoc.html",'Security','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelcons>6 && labelcons <=12){
					...
					var labelcons = opt.w.globals.series[0][0];						
						if(labelcons<=6){
							window.open("/limesurvey/consumption-adhoc.html",'consumption','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
						}else if(labelcons>6 && labelcons <=12){
					...
					var labelcontrib = opt.w.globals.series[0][1];
						if(labelcontrib<=6){
							window.open("/limesurvey/contribution-adhoc.html",'contribution','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
                    ...
                    case 'Publication':
						...
						if(labelpub<=6){
							window.open("/limesurvey/publication-adhoc.html",'Publication','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');
                    ...
                    case 'InnerSource':
						...
						if(labelinrsrc<=6){
							window.open("/limesurvey/innersource-adhoc.html",'InnerSource','width=1200, height=500, scrollbars=no,titlebar=0,toolbar=0');

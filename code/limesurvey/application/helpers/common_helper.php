...
// sets default variable value from config file
    ...
    if (Yii::app()->session['incompleteanswers'] == 'complete' || Yii::app()->session['incompleteanswers'] == 'all' || Yii::app()->session['incompleteanswers'] == 'incomplete'|| Yii::app()->session['incompleteanswers'] == 'aggregate') {
